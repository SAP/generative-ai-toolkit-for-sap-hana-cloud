...
from hana_ai.tools.hana_ml_tools.randomdecisiontree_tools import (
    RDTTreeFitAndSave,
    RDTTreeLoadModelAndPredict,
    RDTTreeLoadModelAndScore
)

class TestRandomDecisionTree(unittest.TestCase):
    """Test Suite for Random Decision Tree."""
    ...
    def setUp(self):
        ...
        self.fit_tool = RDTTreeFitAndSave(connection_context=self.mock_connection)
        self.predict_tool = RDTTreeLoadModelAndPredict(connection_context=self.mock_connection)
        self.score_tool = RDTTreeLoadModelAndScore(connection_context=self.mock_connection)
    ...
    @patch('hana_ai.tools.hana_ml_tools.randomdecisiontree_tools.RandomDecisionTree')
    @patch('hana_ai.tools.hana_ml_tools.randomdecisiontree_tools.ModelStorage')
    def test_fit_and_save(self, mock_storage_class, mock_rdt_class):
        """Test training and saving."""
        mock_model = MagicMock()
        mock_model.fit.return_value = None
        mock_rdt_class.return_value = mock_model
        ...
        self.assertEqual(result_dict["model_name"], "TEST_RDT_MODEL")
    ...
    @patch('hana_ai.tools.hana_ml_tools.randomdecisiontree_tools.RandomDecisionTree')
    @patch('hana_ai.tools.hana_ml_tools.randomdecisiontree_tools.ModelStorage')
    def test_fit_with_large_feature_set(self, mock_storage_class, mock_rdt_class):
    ...
    @patch('hana_ai.tools.hana_ml_tools.randomdecisiontree_tools.RandomDecisionTree')
    @patch('hana_ai.tools.hana_ml_tools.randomdecisiontree_tools.ModelStorage')
    def test_fit_with_missing_table(self, mock_storage_class, mock_rdt_class):
